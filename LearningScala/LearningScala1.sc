object LearningScala1 {
  ...
  val moreStuff=immutableHelloThere + "heah!"     //> moreStuff  : String = Bonjour!There!heah!
  println(moreStuff)                              //> Bonjour!There!heah!
  ...
  // three decimal places of precision to the right.
   ...
   val pii : Double = 3.14159265                  //> pii  : Double = 3.14159265
    
     var Pistring: String =(f"$pii%.3f")          //> Pistring  : String = 3,142
     println(Pistring)                            //> 3,142
}