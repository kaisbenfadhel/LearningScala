object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(129); 
  ...
  val moreStuff=immutableHelloThere + "heah!";System.out.println("""moreStuff  : String = """ + $show(moreStuff ));$skip(21); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(207); 
  
  // EXERCISE
  // Write some code that takes the value of pi, doubles it, and then prints it within a string with
  // three decimal places of precision to the right.
  
   val pii : Double = 3.14159265;System.out.println("""pii  : Double = """ + $show(pii ));$skip(46); 
    
     var Pistring: String =(f"$pii%.3f");System.out.println("""Pistring  : String = """ + $show(Pistring ));$skip(23); 
     println(Pistring)}
}
