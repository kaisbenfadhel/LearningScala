object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(315); 
  ...
  // Write a function that converts a string to upper-case, and use that function of a few test strings.
   def upperCaseIt(x: String): String = {x.toUpperCase()};System.out.println("""upperCaseIt: (x: String)String""");$skip(32); 
   println(upperCaseIt("kais"));$skip(59); 
   println(upperCaseIt("converts a string to upper-case"));$skip(33); 
   println(upperCaseIt("scala"));$skip(38); 
   println(upperCaseIt("ben fadhel"))}
}
