object LearningScala3 {
  ...
  // Write a function that converts a string to upper-case, and use that function of a few test strings.
   def upperCaseIt(x: String): String = {x.toUpperCase()}
                                                  //> upperCaseIt: (x: String)String
   println(upperCaseIt("kais"))                   //> KAIS
   println(upperCaseIt("converts a string to upper-case"))
                                                  //> CONVERTS A STRING TO UPPER-CASE
   println(upperCaseIt("scala"))                  //> SCALA
   println(upperCaseIt("ben fadhel"))             //> BEN FADHEL
}